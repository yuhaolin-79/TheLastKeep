...
void GameMap::drawBackground(QGraphicsScene* scene) {
    qDebug() << "GameMap::drawBackground - loading:" << m_levelData.backgroundPath;
    ...
    qDebug() << "Background loaded, size:" << background.size()
             << ", scaling to:" << m_levelData.cols * m_levelData.tileSize
             << "x" << m_levelData.rows * m_levelData.tileSize;
